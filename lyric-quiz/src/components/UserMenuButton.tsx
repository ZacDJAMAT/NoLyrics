    ...
    if (isGuest && !user) {
        return (
            <button
                ...
                className="flex items-center gap-2 bg-white text-neutral-900 px-4 py-2 rounded-xl font-bold transition-all hover:bg-neutral-200 active:scale-95 shadow-lg text-sm"
